        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('polizas.update', $poliza) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select id="persona_id"
                                ...
                                @foreach($personas as $persona)
                                    <option value="{{ $persona->id }}" {{ old('persona_id', $poliza->persona_id) == $persona->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="vehiculo_id"
                                ...
                                @foreach($vehiculos as $vehiculo)
                                    <option value="{{ $vehiculo->id }}" {{ old('vehiculo_id', $poliza->vehiculo_id) == $vehiculo->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="numero_poliza"
                                          ...
                                          :value="old('numero_poliza', $poliza->numero_poliza)"
                                          required
                                          autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="fecha_compra"
                                              ...
                                              type="date"
                                              class="mt-1 block w-full"
                                              :value="old('fecha_compra', $poliza->fecha_compra?->format('Y-m-d'))"
                                              required />
                            ...
                            <div>
                                ...
                                <x-text-input id="fecha_vencimiento"
                                              ...
                                              type="date"
                                              class="mt-1 block w-full"
                                              :value="old('fecha_vencimiento', $poliza->fecha_vencimiento?->format('Y-m-d'))"
                                              required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="monto_cobertura"
                                              ...
                                              min="0"
                                              class="mt-1 block w-full"
                                              :value="old('monto_cobertura', $poliza->monto_cobertura)"
                                              required />
                            ...
                            <div>
                                ...
                                <x-text-input id="prima_mensual"
                                              ...
                                              min="0"
                                              class="mt-1 block w-full"
                                              :value="old('prima_mensual', $poliza->prima_mensual)"
                                              required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select id="tipo_cobertura"
                                    ...
                                    <option value="basica" {{ old('tipo_cobertura', $poliza->tipo_cobertura) == 'basica' ? 'selected' : '' }}>
                                        {{ __('Basica') }}
                                    </option>
                                    <option value="intermedia" {{ old('tipo_cobertura', $poliza->tipo_cobertura) == 'intermedia' ? 'selected' : '' }}>
                                        {{ __('Intermedia') }}
                                    </option>
                                    <option value="completa" {{ old('tipo_cobertura', $poliza->tipo_cobertura) == 'completa' ? 'selected' : '' }}>
                                        {{ __('Completa') }}
                                    </option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="estado"
                                    ...
                                    <option value="activa" {{ old('estado', $poliza->estado) == 'activa' ? 'selected' : '' }}>
                                        {{ __('Activa') }}
                                    </option>
                                    <option value="vencida" {{ old('estado', $poliza->estado) == 'vencida' ? 'selected' : '' }}>
                                        {{ __('Vencida') }}
                                    </option>
                                    <option value="cancelada" {{ old('estado', $poliza->estado) == 'cancelada' ? 'selected' : '' }}>
                                        {{ __('Cancelada') }}
                                    </option>
                                </select>
