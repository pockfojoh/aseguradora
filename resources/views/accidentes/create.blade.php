        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('accidentes.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select id="poliza_id"
                                ...
                                @foreach ($polizas as $poliza)
                                    <option value="{{ $poliza->id }}" {{ old('poliza_id') == $poliza->id ? 'selected' : '' }}>
